...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createRestaurant() {
    ...
    if (body?.user_user_restaurant_idTorestaurant?.length > 0) {
      const create_user_user_restaurant_idTorestaurant = body.user_user_restaurant_idTorestaurant;
      body.user_user_restaurant_idTorestaurant = {
        create: create_user_user_restaurant_idTorestaurant,
      };
    } else {
      delete body.user_user_restaurant_idTorestaurant;
    }
